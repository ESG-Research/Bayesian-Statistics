...
def naive_bayes(treated_email, word_frequency, class_frequency, return_likelihood = False):    
    ...
    prob_email_given_spam =  prob_email_given_class(treated_email, 'spam',word_frequency = word_frequency, class_frequency = class_frequency)
    ...
    prob_email_given_ham =  prob_email_given_class(treated_email, 'ham', word_frequency = word_frequency, class_frequency = class_frequency)
